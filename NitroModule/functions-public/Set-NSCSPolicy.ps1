    function Set-NSCSPolicy {
        <#
        .SYNOPSIS
            Update a existing CS Policy
        .DESCRIPTION
            Update a existing CS Policy
        .PARAMETER NSSession
        ...
        .EXAMPLE
            Set-NSCSPolicy -NSSession $Session -Name "myCSPolicy" -Rule "HTTP.REQ.HOSTNAME.SET_TEXT_MODE(IGNORECASE).EQ(""nsg.demo.lab"")" -ACtion "cs_act_unifiedgateway"
        .NOTES
            Version:        1.0
        ...
        Process {
            ...
            $response = Invoke-NSNitroRestApi -NSSession $NSSession -OperationMethod PUT -ResourceType cspolicy -Payload $payload 
        }
