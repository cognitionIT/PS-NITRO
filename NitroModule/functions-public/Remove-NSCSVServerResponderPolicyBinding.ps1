    function Remove-NSCSVServerResponderPolicyBinding {
            <#
            .SYNOPSIS
                Remove a NetScaler Responder Policy binding for a CS vServer from the NetScalerConfiguration
            .DESCRIPTION
                Remove a NetScaler Content Switching Policy binding for a CS vServer from the NetScalerConfiguration
            .PARAMETER NSSession
        ...
        Process {
            ...
            $response = Invoke-NSNitroRestApi -NSSession $NSSession -OperationMethod DELETE -ResourceType csvserver_responderpolicy_binding -ResourceName $Name -Arguments $args -Verbose:$VerbosePreference
        }
        End {
