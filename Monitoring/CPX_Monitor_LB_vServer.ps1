<#
.SYNOPSIS
  Monitoring Script for NetScaler CPX LB vServer.
.DESCRIPTION
  Monitoring Script for the NetScaler CPX LB vServer, based upon Stat REST API calls, using Invoke-RestMethod cmdlet.
.NOTES
  Version:        1.0
...
Function ShowAlert {
    # Quick function to create a popup for the demo
    [CmdletBinding()]
    param (
