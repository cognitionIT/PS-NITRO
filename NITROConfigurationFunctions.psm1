...
#region REST API functions
    ...
    Write-Verbose "cognitionIT NSURLProtocol set to $Script:NSURLProtocol"
...
#region Traffic Management
    ...
    function Get-NSService{
        ...
        Process {
            If ($Name) {
                $response = Invoke-NSNitroRestApi -NSSession $NSSession -OperationMethod GET -ResourceType service -ResourceName $Name -Verbose
            }
            Else
            {
                $response = Invoke-NSNitroRestApi -NSSession $NSSession -OperationMethod GET -ResourceType service
            }
        }
        End {
            Write-Verbose "$($MyInvocation.MyCommand): Exit"
...
# ERROR: Disable-NSService renders the NetScaler unresponsive
<#
