...
If ($ConfigTrafficManagementSettings)
{
    ...
    #region Configure Load Balancing - Servers
        ...
        Add-NSServer -NSSession $NSSession -Name "SF2" -IPAddress ($SubnetIP + ".21") -ErrorAction SilentlyContinue
        Add-NSServer -NSSession $NSSession -Name "SF1" -IPAddress ($SubnetIP + ".22") -ErrorAction SilentlyContinue
